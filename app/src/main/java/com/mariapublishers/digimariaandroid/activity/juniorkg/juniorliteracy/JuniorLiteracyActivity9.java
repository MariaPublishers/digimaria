...
public class JuniorLiteracyActivity9 extends BaseActivity implements OnClickListener {

    CardView next, back, run, walk, eat, sing, write, cook, jump, dance, drink, walk_vi, eat_vi, run_vi, write_vi, sing_vi, cook_vi, drink_vi, jump_vi, dance_vi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_junior_literacy9);

        currentContext = JuniorLiteracyActivity9.this;
...
// Executed after startDrag() is called.
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(JuniorLiteracyActivity9.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(JuniorLiteracyActivity9.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onclickNext() {
        startActivity(new Intent(JuniorLiteracyActivity9.this, JuniorLiteracyActivity10.class));
        finish();
    }

    public void onclickBack() {
        startActivity(new Intent(JuniorLiteracyActivity9.this, JuniorLiteracyActivity8.class));
        finish();
    }
    ...
    private void actionbar() {
        ...
        book_name_header.setText("Select the verbs to its respective image (Hold and Drag)");

    }

    private void redirectPage() {
        Intent intent = new Intent(JuniorLiteracyActivity9.this, RedirectPages.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(JuniorLiteracyActivity9.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(JuniorLiteracyActivity9.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
