...
public class JuniorGeneralActivity3 extends BaseActivity implements View.OnClickListener {

    ImageView correct1, correct2, correct3, correct4, wrong1, wrong2, wrong3, wrong4, wrong5, wrong6, wrong7, wrong8;
    CardView next, back;
    int i = 0, cr1 = 0, cr2 = 0, cr3 = 0, cr4 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_junior_general3);

        currentContext = JuniorGeneralActivity3.this;
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(JuniorGeneralActivity3.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(JuniorGeneralActivity3.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onclickNext() {
        startActivity(new Intent(JuniorGeneralActivity3.this, JuniorGeneralActivity4.class));
        finish();
    }

    public void onclickBack() {
        startActivity(new Intent(JuniorGeneralActivity3.this, JuniorGeneralActivity2.class));
        finish();
    }
    ...
    private void actionbar() {
        ...
        book_name_header.setText("Tick the correct picture");

    }

    private void redirectPage() {
        Intent intent = new Intent(JuniorGeneralActivity3.this, RedirectPages.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(JuniorGeneralActivity3.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(JuniorGeneralActivity3.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
