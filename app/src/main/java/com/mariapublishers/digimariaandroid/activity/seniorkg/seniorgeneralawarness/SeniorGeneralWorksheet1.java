...
public class SeniorGeneralWorksheet1 extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_senior_general_worksheet1);

        currentContext = SeniorGeneralWorksheet1.this;
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(SeniorGeneralWorksheet1.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(SeniorGeneralWorksheet1.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onclickNext() {
        startActivity(new Intent(SeniorGeneralWorksheet1.this, SeniorGeneralWorksheet2.class));
        finish();
    }

    public void onclickBack() {
        startActivity(new Intent(SeniorGeneralWorksheet1.this, SeniorGeneralActivity6.class));
        finish();
    }
    ...
    private void actionbar() {
        ...
        book_name_header.setText("Match the water sources with their names");

    }

    private void redirectPage() {
        Intent intent = new Intent(SeniorGeneralWorksheet1.this, RedirectPages.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorGeneralWorksheet1.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorGeneralWorksheet1.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
