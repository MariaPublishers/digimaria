...
public class SeniorFlashCard2 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentContext = SeniorFlashCard2.this;
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorFlashCard2.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorFlashCard2.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
        ...
        toback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SeniorFlashCard2.this, BookLanding.class);
        ...
        text.setText("Bb");
        text2.setText("Bb");
        subtext.setText("bell");
        subtext.setAllCaps(true);
        Glide.with(this)
                .load("https://digimaria.com/ERP/public/mobileasset/drawable/drawable/flash_bell.png")
                .error(R.drawable.ic_sync_problem_black_24dp)
                .into(image_book);
        //  image_book.setImageDrawable(getResources().getDrawable(R.drawable.flash_bell));

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SeniorFlashCard2.this.finish();
                if (mp != null) {
                    if (mp != null) {
                        mp.stop();
                    }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SeniorFlashCard2.this, SeniorFlashCard3.class));
        ...
        alpaflash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    mp.setDataSource("https://digimaria.com/ERP/public/mobileasset/raw/raw/b.m4a");
                    mp.prepare();
                    mp.start();
                } catch (Exception e) {
                    // handle exception
                }
                //   mp = create(SeniorFlashCard2.this, R.raw.b);
//                mp.start();
            }
        });
    ...
    public void alertError(String message) {
        ...
        new SweetAlertDialog(SeniorFlashCard2.this, SweetAlertDialog.ERROR_TYPE)
                .setTitleText("Oops...")
