...
public class SeniorFlashCard4 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentContext = SeniorFlashCard4.this;
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorFlashCard4.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorFlashCard4.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
        ...
        toback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SeniorFlashCard4.this, BookLanding.class);
        ...
        text.setText("Dd");
        text2.setText("Dd");
        subtext.setText("drum");
        subtext.setAllCaps(true);
        mp= new MediaPlayer();
   //     image_book.setImageDrawable(getResources().getDrawable(R.drawable.flash_drum));
        Glide.with(this)
                .load("https://digimaria.com/ERP/public/mobileasset/drawable/drawable/flash_drum.png")
                .error(R.drawable.ic_sync_problem_black_24dp)
                .into(image_book);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SeniorFlashCard4.this.finish();
                 if (mp != null) {
                    mp.stop();
                }
            }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SeniorFlashCard4.this, SeniorFlashCard5.class));
                 if (mp != null) {
                    mp.stop();
                }
            }
        ...
        alpaflash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    mp.setDataSource("https://digimaria.com/ERP/public/mobileasset/raw/raw/d.m4a");
...
//                mp = create(SeniorFlashCard4.this, R.raw.d);
//                mp.start();
            }
        });
    ...
    public void alertError(String message) {
        ...
        new SweetAlertDialog(SeniorFlashCard4.this, SweetAlertDialog.ERROR_TYPE)
                .setTitleText("Oops...")
