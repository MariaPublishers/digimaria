...
public class SeniorGeneralWorksheet3 extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_senior_general_worksheet3);

        currentContext = SeniorGeneralWorksheet3.this;
    ...
    public void actionbar() {
        ...
        book_name_header.setText("Read the clues and connect them");
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorGeneralWorksheet3.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorGeneralWorksheet3.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
    ...
    public void onclickNext() {
        startActivity(new Intent(SeniorGeneralWorksheet3.this, SeniorGeneralWorksheet4.class));
        finish();
    }

    public void onclickBack() {
        startActivity(new Intent(SeniorGeneralWorksheet3.this, SeniorGeneralWorksheet2.class));
        finish();
    }
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(SeniorGeneralWorksheet3.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(SeniorGeneralWorksheet3.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void redirectPage() {
        Intent intent = new Intent(SeniorGeneralWorksheet3.this, RedirectPages.class);
