...
public class MickyColor extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_micky_color);

        currentContext = MickyColor.this;
...
//        save.setOnClickListener(this);
        ...
        toback.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MickyColor.this, BookLanding.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(MickyColor.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(MickyColor.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.new_btn) {
            new SweetAlertDialog(MickyColor.this, SweetAlertDialog.WARNING_TYPE)
        ...
        if (v.getId() == R.id.bird) {
            startActivity(new Intent(MickyColor.this, BirdColor.class));
        }
