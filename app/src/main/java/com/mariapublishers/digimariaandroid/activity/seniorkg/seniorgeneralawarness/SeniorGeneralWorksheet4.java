...
public class SeniorGeneralWorksheet4 extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_senior_general_worksheet4);

        currentContext = SeniorGeneralWorksheet4.this;
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(SeniorGeneralWorksheet4.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(SeniorGeneralWorksheet4.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onclickBack() {
        startActivity(new Intent(SeniorGeneralWorksheet4.this, SeniorGeneralWorksheet3.class));
        finish();
    }
    ...
    private void redirectPage() {
        Intent intent = new Intent(SeniorGeneralWorksheet4.this, RedirectPages.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorGeneralWorksheet4.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorGeneralWorksheet4.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
