...
public class JuniorNumeracyActivity10 extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_junior_numeracy10);

        currentContext = JuniorNumeracyActivity10.this;
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(JuniorNumeracyActivity10.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(JuniorNumeracyActivity10.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onclickBack() {
        startActivity(new Intent(JuniorNumeracyActivity10.this, JuniorNumeracyActivity9.class));
        finish();
    }
    ...
    private void actionbar() {
        ...
        book_name_header.setText("Choose the correct numeral for the given number name");

    }

    private void redirectPage() {
        Intent intent = new Intent(JuniorNumeracyActivity10.this, RedirectPages.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(JuniorNumeracyActivity10.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(JuniorNumeracyActivity10.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
