...
public class SeniorFlashCard3 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentContext = SeniorFlashCard3.this;
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorFlashCard3.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorFlashCard3.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
        ...
        toback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SeniorFlashCard3.this, BookLanding.class);
        ...
        //   image_book.setImageDrawable(getResources().getDrawable(R.drawable.flash_car));
        Glide.with(this)
                .load("https://digimaria.com/ERP/public/mobileasset/drawable/drawable/flash_car.png")
                .error(R.drawable.ic_sync_problem_black_24dp)
                .into(image_book);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SeniorFlashCard3.this.finish();
                if (mp != null) {
                    mp.stop();
                }
            }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SeniorFlashCard3.this, SeniorFlashCard4.class));
                if (mp != null) {
                    mp.stop();
                }
            }
        ...
        alpaflash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    mp.setDataSource("https://digimaria.com/ERP/public/mobileasset/raw/raw/c.m4a");
                ...
                // mp = create(SeniorFlashCard3.this, R.raw.c);
                //   mp.start();
            }
        });
    ...
    public void alertError(String message) {
        ...
        new SweetAlertDialog(SeniorFlashCard3.this, SweetAlertDialog.ERROR_TYPE)
                .setTitleText("Oops...")
