...
import com.mariapublishers.digimariaandroid.activity.nursery.funwithcolor.BirdColor;
import com.mariapublishers.digimariaandroid.activity.nursery.funwithcolor.DeerColor;
import com.mariapublishers.digimariaandroid.activity.nursery.funwithcolor.DrawingView;
import com.mariapublishers.digimariaandroid.prefference.Pref;
import com.mariapublishers.digimariaandroid.service.MusicService;

import cn.pedant.SweetAlert.SweetAlertDialog;

public class BugColor extends BaseActivity implements OnClickListener {

    private ImageButton currPaint, drawbtn, baru, erase, save;
    private DrawingView drawView;
    CardView deer, sparrow;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bug_color);

        currentContext = BugColor.this;
...
//        save.setOnClickListener(this);
        ...
        toback.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BugColor.this, BookLanding.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(BugColor.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(BugColor.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.new_btn) {
            new SweetAlertDialog(BugColor.this, SweetAlertDialog.WARNING_TYPE)
        ...
        if (v.getId() == R.id.deer) {
            startActivity(new Intent(BugColor.this, DeerColor.class));
        }

        if (v.getId() == R.id.sparrow) {
            startActivity(new Intent(BugColor.this, BirdColor.class));
        }
