...
public class SeniorFlashCard20 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentContext = SeniorFlashCard20.this;
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorFlashCard20.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorFlashCard20.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
        ...
        toback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SeniorFlashCard20.this, BookLanding.class);
        ...
        text.setText("Tt");
        text2.setText("Tt");
        subtext.setText("tiger");
        subtext.setAllCaps(true);
        Glide.with(this)
                .load("https://digimaria.com/ERP/public/mobileasset/drawable/drawable/flash_tiger.png")
                .error(R.drawable.ic_sync_problem_black_24dp)
                .into(image_book);
       // image_book.setImageDrawable(getResources().getDrawable(R.drawable.flash_tiger));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SeniorFlashCard20.this, SeniorFlashCard21.class));
            }
        });
        mp = new MediaPlayer();
        alpaflash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    mp.setDataSource("https://digimaria.com/ERP/public/mobileasset/raw/raw/t.m4a");
    ...
    public void alertError(String message) {
        ...
        new SweetAlertDialog(SeniorFlashCard20.this, SweetAlertDialog.ERROR_TYPE)
                .setTitleText("Oops...")
