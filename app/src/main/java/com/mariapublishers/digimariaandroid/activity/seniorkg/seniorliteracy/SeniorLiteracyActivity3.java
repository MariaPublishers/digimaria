...
public class SeniorLiteracyActivity3 extends BaseActivity implements View.OnClickListener {
    ...
    int cr1 = 0, cr2 = 0, cr3 = 0, cr4 = 0, cr5 = 0, wr1 = 0, wr2 = 0, wr3 = 0, wr4 = 0, wr5 = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_senior_literacy3);

        currentContext = SeniorLiteracyActivity3.this;
    ...
    private void redirectPage() {
        Intent intent = new Intent(SeniorLiteracyActivity3.this, RedirectPages.class);
    ...
    public void actionbar() {
        ...
        book_name_header.setText("Match one with many");
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorLiteracyActivity3.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorLiteracyActivity3.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
    ...
    public void initialize() {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SeniorLiteracyActivity3.this, SeniorLiteracyActivity4.class));
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SeniorLiteracyActivity3.this, SeniorLiteracyActivity2.class));
                finish();
            }
        });
    }
    ...
    public void alertError(String msg) {
        ...
        new SweetAlertDialog(SeniorLiteracyActivity3.this, SweetAlertDialog.ERROR_TYPE)
                .setTitleText("Oops...")
                .setConfirmText("OK")
                .setContentText(msg)
                .show();
    ...
    public void toBack() {
        ...
        new SweetAlertDialog(SeniorLiteracyActivity3.this, SweetAlertDialog.SUCCESS_TYPE)
                .setTitleText("Hurray!")
