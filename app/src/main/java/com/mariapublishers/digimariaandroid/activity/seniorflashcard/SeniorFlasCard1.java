...
public class SeniorFlasCard1 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentContext = SeniorFlasCard1.this;
        off = findViewById(R.id.off);
        volval = pref.getVolumeval();
        volumenote = findViewById(R.id.volumenote);
        image_book = findViewById(R.id.image_book);
        Glide.with(this)
                .load("https://digimaria.com/ERP/public/mobileasset/drawable/drawable/flash_ant.png")
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorFlasCard1.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorFlasCard1.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
        ...
        toback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SeniorFlasCard1.this, BookLanding.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SeniorFlasCard1.this, SeniorFlashCard2.class));
        ...
        alpaflash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    mp.setDataSource("https://digimaria.com/ERP/public/mobileasset/raw/raw/a.m4a");
                    mp.prepare();
                    mp.start();
                } catch (Exception e) {
                    // handle exception
                }
              //  mp = create(SeniorFlasCard1.this, R.raw.a);
               // mp.start();
            }
        });
    ...
    public void alertError(String message) {
        ...
        new SweetAlertDialog(SeniorFlasCard1.this, SweetAlertDialog.ERROR_TYPE)
                .setTitleText("Oops...")
