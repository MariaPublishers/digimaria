...
public class JuniorGeneralActivity5 extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_junior_general5);

        currentContext = JuniorGeneralActivity5.this;
    ...
    public void actionbar() {
        ...
        book_name_header.setText("Help these people to find their tools");
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(JuniorGeneralActivity5.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(JuniorGeneralActivity5.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
    ...
    public void onclickNext() {
        startActivity(new Intent(JuniorGeneralActivity5.this, JuniorGeneralActivity6.class));
        finish();
    }

    public void onclickBack() {
        startActivity(new Intent(JuniorGeneralActivity5.this, JuniorGeneralActivity4.class));
        finish();
    }
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(JuniorGeneralActivity5.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(JuniorGeneralActivity5.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void redirectPage() {
        Intent intent = new Intent(JuniorGeneralActivity5.this, RedirectPages.class);
