...
public class JuniorGeneralActivity2 extends BaseActivity implements View.OnClickListener {

    ImageView correct1, correct2, correct3, correct4, correct5, correct6, correct7, wrong1, wrong2, wrong3, wrong4, wrong5;
    CardView next, back;
    int i = 0, cr1 = 0, cr2 = 0, cr3 = 0, cr4 = 0, cr5 = 0, cr6 = 0, cr7 = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_junior_general2);

        currentContext = JuniorGeneralActivity2.this;
    ...
    private void initialize() {
        ...
        pDialog = new SweetAlertDialog(JuniorGeneralActivity2.this, SweetAlertDialog.PROGRESS_TYPE);
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(JuniorGeneralActivity2.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(JuniorGeneralActivity2.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onclickNext() {
        startActivity(new Intent(JuniorGeneralActivity2.this, JuniorGeneralActivity3.class));
        finish();
    }

    public void onclickBack() {
        startActivity(new Intent(JuniorGeneralActivity2.this, JuniorGeneralActivity1.class));
        finish();
    }
    ...
    private void actionbar() {
        ...
        book_name_header.setText("Tick the healthy food");

    }

    private void redirectPage() {
        Intent intent = new Intent(JuniorGeneralActivity2.this, RedirectPages.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(JuniorGeneralActivity2.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(JuniorGeneralActivity2.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
