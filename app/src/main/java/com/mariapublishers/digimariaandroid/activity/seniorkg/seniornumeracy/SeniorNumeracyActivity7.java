...
public class SeniorNumeracyActivity7 extends BaseActivity implements View.OnClickListener {

    ImageView correct1, correct2, correct3, correct4, correct5, wrong1, wrong2, wrong3, wrong4, wrong5;
    CardView next, back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_senior_numeracy7);

        currentContext = SeniorNumeracyActivity7.this;
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(SeniorNumeracyActivity7.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(SeniorNumeracyActivity7.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onclickNext() {
        startActivity(new Intent(SeniorNumeracyActivity7.this, SeniorNumeracyActivity8.class));
        finish();
    }

    public void onclickBack() {
        startActivity(new Intent(SeniorNumeracyActivity7.this, SeniorNumeracyActivity6.class));
        finish();
    }
    ...
    private void actionbar() {
        ...
        book_name_header.setText("Tick the correct statement");

    }

    private void redirectPage() {
        Intent intent = new Intent(SeniorNumeracyActivity7.this, RedirectPages.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorNumeracyActivity7.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorNumeracyActivity7.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
