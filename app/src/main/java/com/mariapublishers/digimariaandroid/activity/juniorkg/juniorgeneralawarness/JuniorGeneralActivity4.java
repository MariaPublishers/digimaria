...
public class JuniorGeneralActivity4 extends BaseActivity implements View.OnClickListener {

    ImageView correct1, correct2, correct3, correct4, wrong1, wrong2, wrong3, wrong4, wrong5;
    CardView next, back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_junior_general4);

        currentContext = JuniorGeneralActivity4.this;
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(JuniorGeneralActivity4.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(JuniorGeneralActivity4.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onclickNext() {
        startActivity(new Intent(JuniorGeneralActivity4.this, JuniorGeneralActivity5.class));
        finish();
    }

    public void onclickBack() {
        startActivity(new Intent(JuniorGeneralActivity4.this, JuniorGeneralActivity3.class));
        finish();
    }
    ...
    private void actionbar() {
        ...
        book_name_header.setText("Select the good manners you have learnt");

    }

    private void redirectPage() {
        Intent intent = new Intent(JuniorGeneralActivity4.this, RedirectPages.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(JuniorGeneralActivity4.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(JuniorGeneralActivity4.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
