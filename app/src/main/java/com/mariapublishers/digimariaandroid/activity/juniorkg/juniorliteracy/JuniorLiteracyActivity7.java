...
public class JuniorLiteracyActivity7 extends BaseActivity implements OnClickListener {

    ImageView correct1, correct2, correct3, correct4, correct5, wrong1, wrong2, wrong3, wrong4, wrong5, wrong6, wrong7, wrong8, wrong9, wrong10;
    CardView next, back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_junior_literacy7);

        currentContext = JuniorLiteracyActivity7.this;
    ...
    public void alertMessage(int type, String title, String message) {
        ...
        if (type == 1) {
            ...
            new SweetAlertDialog(JuniorLiteracyActivity7.this, SweetAlertDialog.SUCCESS_TYPE)
            ...
            new SweetAlertDialog(JuniorLiteracyActivity7.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onclickNext() {
        startActivity(new Intent(JuniorLiteracyActivity7.this, JuniorLiteracyActivity8.class));
        finish();
    }

    public void onclickBack() {
        startActivity(new Intent(JuniorLiteracyActivity7.this, JuniorLiteracyActivity6.class));
        finish();
    }
    ...
    private void actionbar() {
        ...
        book_name_header.setText("Select the image based on the vowel given");

    }

    private void redirectPage() {
        Intent intent = new Intent(JuniorLiteracyActivity7.this, RedirectPages.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(JuniorLiteracyActivity7.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(JuniorLiteracyActivity7.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
