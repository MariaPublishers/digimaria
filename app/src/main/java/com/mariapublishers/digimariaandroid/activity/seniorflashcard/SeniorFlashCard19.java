...
public class SeniorFlashCard19 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentContext = SeniorFlashCard19.this;
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(SeniorFlashCard19.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(SeniorFlashCard19.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
        ...
        toback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SeniorFlashCard19.this, BookLanding.class);
        ...
        text.setText("Ss");
        text2.setText("Ss");
        subtext.setText("snail");
        subtext.setAllCaps(true);
        //image_book.setImageDrawable(getResources().getDrawable(R.drawable.flash_snail));
        Glide.with(this)
                .load("https://digimaria.com/ERP/public/mobileasset/drawable/drawable/flash_snail.png")
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SeniorFlashCard19.this, SeniorFlashCard20.class));
            }
        });
        ...
        alpaflash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    mp.setDataSource("https://digimaria.com/ERP/public/mobileasset/raw/raw/s.m4a");
    ...
    public void alertError(String message) {
        ...
        new SweetAlertDialog(SeniorFlashCard19.this, SweetAlertDialog.ERROR_TYPE)
                .setTitleText("Oops...")
