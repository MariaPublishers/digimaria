...
public class DeerColor extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deer_color);

        currentContext = DeerColor.this;
...
//        save.setOnClickListener(this);
        ...
        toback.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DeerColor.this, BookLanding.class);
            ...
            public void onClick(View v) {
                ...
                if (volval != null) {
                    if (volval.equals("1")) {
                        ...
                        stopService(new Intent(DeerColor.this, MusicService.class));
                    } else if (volval.equals("0")) {
                        pref.setVolumeval("1");
                        volval = pref.getVolumeval();
                        volumenote.setImageResource(R.drawable.volumeup);
                        startService(new Intent(DeerColor.this, MusicService.class));
                    }
                } else {
                    pref.setVolumeval("1");
                    volumenote.setImageResource(R.drawable.volumeup);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.new_btn) {
            new SweetAlertDialog(DeerColor.this, SweetAlertDialog.WARNING_TYPE)
        ...
        if (v.getId() == R.id.parrot) {
            startActivity(new Intent(DeerColor.this, ParrotDrawing.class));
        }

        if (v.getId() == R.id.bug) {
            startActivity(new Intent(DeerColor.this, BugColor.class));
        }
