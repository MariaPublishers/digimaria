 ...
 */
public class GetSchoolsTask extends AsyncTask<String,Void,String> {
    private DownloadCallback callback;


    public GetSchoolsTask(DownloadCallback downloadCallback) {
        try {
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            try {
                HttpPost request = new HttpPost(APIUrl.BASE_URL_2+"getschools");
                JSONObject jObj = new JSONObject();
                jObj.put("city_id", strings[0]);
